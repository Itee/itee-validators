 ...
 *
 */
function N(t){return!c(t)&&t.constructor===Number}function h(t){return!N(t)}function A(t){return Number.isInteger(t)}function I(t){return!h(t)&&(!Number.isNaN(t)&&(!x(t)&&t%1!=0))}
/**
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 *
 ...
 *
 */
function d(t){return!c(t)&&t.constructor===Object}function E(t){return!d(t)}
/**
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 *
 ...
 *
 */
class U{constructor(){this.validators={Boolean:i,Number:N,Integer:A,Float:I,Array:r,String:g,Object:d,Symbol:O,Function:u},this.errors=[]}add(t,r){if(m(t))throw new TypeError("Validator: Expect type to be a string");if(s(r)&&E(r))throw new TypeError("Validator: Expect validator to be an object or a function");if(a(this.validators[t]))throw new TypeError(`Validator: a validator is already defined for type '${t}'`);this.validators[t]=r}remove(t){delete this.validators[t]}getAvalaibleTypes(){const t=[];for(let r in this.validators)t.push(r);return t}check(t,r,n=!0){const e=this.validators[r];if(c(e))throw new TypeError(`Validator: Unable to find schema validation of type '${r}'`);let i=!0;if(u(e))i=e(t);else{if(!d(e))throw new TypeError(`Validator: Unknown validator of type '${r}'`);{let o=!0;for(let u in e){const f=e[u];if(c(f))throw new TypeError(`Validator: Missing validator for key '${u}' of type '${r}'`);const p=t[u],l=f.required;if(c(p)){if(!l)continue;o=!1}let x=f.fn;if(a(x)){if(s(x))throw new TypeError(`Validator: Invalid validation function for '${u}' with type '${r}'`);o=x(p)}else o=this.check(p,f.type,n);if(!1===o&&(this.errors.push(`Validator: Invalid property '${u}' of type '${f.type}' with value '${p}' in object of type '${r}'`),i=!1,n))break}}}return i}}
/**
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 *
