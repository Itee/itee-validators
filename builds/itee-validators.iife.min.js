...
/**
	 ...
	 * }
	 *
	 */function l(r){return!g(r)&&(!Number.isNaN(r)&&!Number.isFinite(r))}function y(r){return r===Number.POSITIVE_INFINITY}function N(r){return 0===r&&1/r===Number.POSITIVE_INFINITY}
/**
	 * @author [Tristan Valcke]{@link https://github.com/Itee}
	 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
	 *
	 ...
	 *
	 */
function A(r){return!c(r)&&r.constructor===Number}function g(r){return!A(r)}function h(r){return Number.isInteger(r)}function d(r){return!g(r)&&(!Number.isNaN(r)&&(!l(r)&&r%1!=0))}
/**
	 * @author [Tristan Valcke]{@link https://github.com/Itee}
	 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
	 *
...
/**
	 ...
	 *
	 */
function p(r){return"string"==typeof r||r instanceof String}function m(r){return!p(r)}
/**
	 * @author [Tristan Valcke]{@link https://github.com/Itee}
	 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
	 *
...
/**
	 ...
	 *
	 */
function O(r){if(b(r))return!1;if(0===r.length)return!0;for(let t in r)if(Object.prototype.hasOwnProperty.call(r,t))return!1;return!0}
/**
	 * @author [Tristan Valcke]{@link https://github.com/Itee}
	 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
	 *
	 ...
	 *
	 */
function v(r){return!m(r)&&0===r.length}
/**
	 * @author [Tristan Valcke]{@link https://github.com/Itee}
	 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
	 *
	 ...
	 *
	 */
function U(r){return!m(r)&&(!v(r)&&!/\S/.test(r))}
/**
	 * @author [Tristan Valcke]{@link https://github.com/Itee}
	 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
	 *
...
/**
	 ...
	 *
	 */
function S(r){return!c(r)&&(!!v(r)||(!!i(r)||!!O(r)))}
/**
	 * @author [Tristan Valcke]{@link https://github.com/Itee}
	 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
	 *
	 ...
	 *
	 */
class T{constructor(){this.validators={Boolean:e,Number:A,Integer:h,Float:d,Array:t,String:p,Object:I,Symbol:F,Function:o},this.errors=[]}add(r,t){if(m(r))throw new TypeError("Validator: Expect type to be a string");if(f(t)&&b(t))throw new TypeError("Validator: Expect validator to be an object or a function");if(s(this.validators[r]))throw new TypeError(`Validator: a validator is already defined for type '${r}'`);this.validators[r]=t}remove(r){delete this.validators[r]}getAvalaibleTypes(){const r=[];for(let t in this.validators)r.push(t);return r}check(r,t,n=!0){const i=this.validators[t];if(c(i))throw new TypeError(`Validator: Unable to find schema validation of type '${t}'`);let e=!0;if(o(i))e=i(r);else{if(!I(i))throw new TypeError(`Validator: Unknown validator of type '${t}'`);{let u=!0;for(let o in i){const a=i[o];if(c(a))throw new TypeError(`Validator: Missing validator for key '${o}' of type '${t}'`);const l=r[o],y=a.required;if(c(l)){if(!y)continue;u=!1}let N=a.fn;if(s(N)){if(f(N))throw new TypeError(`Validator: Invalid validation function for '${o}' with type '${t}'`);u=N(l)}else u=this.check(l,a.type,n);if(!1===u&&(this.errors.push(`Validator: Invalid property '${o}' of type '${a.type}' with value '${l}' in object of type '${t}'`),e=!1,n))break}}}return e}}
/**
	 * @author [Tristan Valcke]{@link https://github.com/Itee}
	 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
	 *
	 ...
	 *
	 */
function V(r){return r instanceof ArrayBuffer}
/**
	 * @author [Tristan Valcke]{@link https://github.com/Itee}
	 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
	 *
	 ...
	 *
	 */
function _(r){return r instanceof BigInt64Array}
/**
	 * @author [Tristan Valcke]{@link https://github.com/Itee}
	 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
	 *
...
/**
	 ...
	 *
	 */
function B(r){return r instanceof Float32Array}
/**
	 * @author [Tristan Valcke]{@link https://github.com/Itee}
	 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
	 *
	 ...
	 *
	 */
function M(r){return r instanceof Float64Array}
/**
	 * @author [Tristan Valcke]{@link https://github.com/Itee}
	 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
	 *
	 ...
	 *
	 */
function j(r){return r instanceof Int16Array}
/**
	 * @author [Tristan Valcke]{@link https://github.com/Itee}
	 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
	 *
	 ...
	 *
	 */
function $(r){return r instanceof Int32Array}
/**
	 * @author [Tristan Valcke]{@link https://github.com/Itee}
	 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
	 *
	 ...
	 *
	 */
function L(r){return r instanceof Int8Array}
/**
	 * @author [Tristan Valcke]{@link https://github.com/Itee}
	 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
	 *
	 ...
	 *
	 */
function P(r){return r instanceof Uint16Array}
/**
	 * @author [Tristan Valcke]{@link https://github.com/Itee}
	 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
	 *
	 ...
	 *
	 */
function k(r){return r instanceof Uint32Array}
/**
	 * @author [Tristan Valcke]{@link https://github.com/Itee}
	 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
	 *
	 ...
	 *
	 */
function C(r){return r instanceof Uint8Array}
/**
	 * @author [Tristan Valcke]{@link https://github.com/Itee}
	 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
	 *
	 ...
	 *
	 */
function R(r){return r instanceof Uint8ClampedArray}r.Validator=void 0,c(r.Validator)&&(r.Validator=new T);
/**
	 * @author [Tristan Valcke]{@link https://github.com/Itee}
	 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
	 *
	 ...
	 *
	 */
const Z=4.5e-10,x=-273.14999999955,G=-459.67;
/**
	 * @author [Tristan Valcke]{@link https://github.com/Itee}
	 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
	 *
	 ...
	 *
	 */
function Y(r){return A(r)&&r>=x}function K(r){return!Y(r)}
/**
	 * @author [Tristan Valcke]{@link https://github.com/Itee}
	 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
	 *
	 ...
	 * }
	 *
	 */function X(r){return A(r)&&r>=G}function D(r){return!X(r)}
/**
	 * @author [Tristan Valcke]{@link https://github.com/Itee}
	 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
	 *
	 ...
	 * }
	 *
	 */function H(r){return A(r)&&r>=Z}function q(r){return!H(r)}
/**
	 * @author [Tristan Valcke]{@link https://github.com/Itee}
	 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
	 *
	 ...
	 * }
	 *
	 */return r.ABSOLUTE_ZERO_CELSIUS=x,r.ABSOLUTE_ZERO_FAHRENHEIT=G,r.ABSOLUTE_ZERO_KELVIN=Z,r.isArray=t,r.isArrayBuffer=V,r.isArrayOfArray=
/**
	 * @author [Tristan Valcke]{@link https://github.com/Itee}
	 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
	 *
...
/**
	 ...
	 *
	 */
function(r){if(n(r))return!1;if(i(r))return!1;for(let t=0,n=r.length;t<n;t++)if(g(r[t]))return!1;return!0},r.isArrayOfObject=function(r){if(n(r))return!1;if(i(r))return!1;for(let t=0,n=r.length;t<n;t++)if(b(r[t]))return!1;return!0},r.isArrayOfSingleElement=
/**
	 * @author [Tristan Valcke]{@link https://github.com/Itee}
	 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
	 *
...
/**
	 ...
	 * }
	 *
	 */,r.isFloat=d,r.isFloat32Array=B,r.isFloat64Array=M,r.isFunction=o,r.isInfinite=l,r.isInfiniteNegative=function(r){return r===Number.NEGATIVE_INFINITY},r.isInfinitePositive=y,r.isInt16Array=j,r.isInt32Array=$,r.isInt8Array=L,r.isInteger=h,r.isKelvin=H,r.isMaxNegative=function(r){return r===-Number.MAX_VALUE}
/**
	 * @author [Tristan Valcke]{@link https://github.com/Itee}
	 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
	 *
...
/**
	 ...
	 * }
	 *
	 */,r.isNotArrayOfUndefined=function(r){if(n(r))return!0;if(i(r))return!0;for(let t=0,n=r.length;t<n;t++)if(E(r[t]))return!0;return!1}
/**
	 * @author [Tristan Valcke]{@link https://github.com/Itee}
	 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
	 *
	 ...
	 * }
	 *
	 */,r.isNotBigInt64Array=function(r){return!_(r)},r.isNotBigUint64Array=function(r){return!w(r)},r.isNotBlankString=function(r){return!U(r)},r.isNotBoolean=u,r.isNotCelsius=K,r.isNotDefined=c,r.isNotEmpty=function(r){return!S(r)},r.isNotEmptyArray=function(r){return!!n(r)||r.length>0},r.isNotEmptyObject=function(r){return!O(r)},r.isNotEmptyString=function(r){return!v(r)},r.isNotFahrenheit=D,r.isNotFloat32Array=function(r){return!B(r)},r.isNotFloat64Array=function(r){return!M(r)},r.isNotFunction=f,r.isNotInt16Array=function(r){return!j(r)},r.isNotInt32Array=function(r){return!$(r)},r.isNotInt8Array=function(r){return!L(r)},r.isNotKelvin=q,r.isNotNull=a,r.isNotNumber=g,r.isNotObject=b,r.isNotString=m,r.isNotSymbol=function(r){return"symbol"!=typeof r},r.isNotTemperature=function(r){return q(r)&&K(r)&&D(r)},r.isNotUint16Array=function(r){return!P(r)},r.isNotUint32Array=function(r){return!k(r)},r.isNotUint8Array=function(r){return!C(r)},r.isNotUint8ClampedArray=function(r){return!R(r)},r.isNotUndefined=E,r.isNull=function(r){return null===r},r.isNumber=A,r.isNumberNegative=function(r){return A(r)&&r<0},r.isNumberPositive=function(r){return!g(r)&&(r>0||N(r)||y(r))},r.isObject=I,r.isString=p,r.isSymbol=F,r.isTemperature=function(r){return H(r)||Y(r)||X(r)},r.isTrue=function(r){return e(r)&&!0===r},r.isUint16Array=P,r.isUint32Array=k,r.isUint8Array=C,r.isUint8ClampedArray=R,r.isUndefined=function(r){return void 0===r},r.isZero=function(r){return 0===r},r.isZeroNegative=function(r){return 0===r&&1/r===Number.NEGATIVE_INFINITY},r.isZeroPositive=N,Object.defineProperty(r,"__esModule",{value:!0}),r}({});
