...
const isString = require( '../../builds/itee-validators.cjs' ).isString
    ...
    describe( 'isString()', () => {
        ...
        it( 'should return false when the value is a void', () => {
            ...
            for ( let i = 0, n = _dataSet.length ; i < n ; i++ ) {
                expect( isString( _dataSet[ i ] ) ).to.be.false
            }
        ...
        it( 'should return true when the value is a string', () => {
            ...
            for ( let i = 0, n = _dataSet.length ; i < n ; i++ ) {
                expect( isString( _dataSet[ i ] ) ).to.be.true
            }
