...
const isStringTest         = require( './isString.tests' )
const isNotStringTest      = require( './isNotString.tests' )
const isEmptyStringTest    = require( './isEmptyString.tests' )
const isNotEmptyStringTest = require( './isNotEmptyString.tests' )
const isBlankStringTest    = require( './isBlankString.tests' )
const isNotBlankStringTest = require( './isNotBlankString.tests' )

function StringsTests () {
    ...
    describe( 'Strings', () => {
        ...
        isNotStringTest()
        isEmptyStringTest()
        isNotEmptyStringTest()
        isBlankStringTest()
        isNotBlankStringTest()

    } )

}

module.exports = StringsTests
